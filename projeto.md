# Desafio 03.01 - Criando um projeto do zero (Blog)
Embora seja do zero, ele tem testes já pré concebidos portanto terá parte já estruturada para manter a viabilidade dos testes.

//tags: #react-icons# #FetchAPI# #Prismic# #Figma#

# Atividades a considerar
  1. Consumir dados do Prismic
  2. Implementar layout a partir do Figma
  3. 
